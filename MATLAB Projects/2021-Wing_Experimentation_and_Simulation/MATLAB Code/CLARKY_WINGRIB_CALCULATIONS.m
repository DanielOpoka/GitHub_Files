...
%% Study of the Internal Stresses

% By approximating the positions of where the trusses are connected 
% to the upper beam of the wing, a system of 8 equations is thus 
% solved to obtain the required forces to that the trusses must 
% withstand to keep the shape of the wing.
